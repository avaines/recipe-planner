  ...
  <nav class="bg-white border-b border-gray-200 px-4 py-3 no-print">
    <div class="flex items-center justify-between">
      ...
      <div class="hidden md:flex items-center gap-5 text-sm font-medium">
        ...
        <router-link v-if="user.loggedIn" to="/recipe-instructions" class="hover:text-blue-600" :class="{ 'text-blue-600': $route.path.startsWith('/recipe-instructions') }">Recipe Instructions</router-link>
    ...
    <div v-if="mobileOpen" class="md:hidden mt-3 border-t border-gray-200 pt-3 space-y-2">
      <div class="flex flex-col gap-2 text-sm font-medium">
        ...
        <router-link v-if="user.loggedIn" to="/recipe-instructions" class="py-1 hover:text-blue-600" :class="{ 'text-blue-600': $route.path.startsWith('/recipe-instructions') }" @click="mobileOpen=false">Recipe Instructions</router-link>
